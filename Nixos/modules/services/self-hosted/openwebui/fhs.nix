...
# not copies) -- only what pip installs inside it, at runtime via the
# @install action, is impure. See ../self-hosted.nix's mkFHSVenv, which
# this is a thin wrapper around with this service's own targetPkgs.
#
